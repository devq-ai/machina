...
class BrowserToolsContextServer:
    """Main MCP server implementation"""

    def __init__(self):
        self.server = Server("browser-tools-context-server")
        ...
        async with mcp.server.stdio.stdio_server() as (read_stream, write_stream):
            await self.server.run(
                ...
                InitializationOptions(
                    server_name="browser-tools-context-server",
...
async def main():
    server = BrowserToolsContextServer()
    await server.run()
