...
app = FastAPI(
    title="gcp-mcp",
    description="Production MCP Server for gcp-mcp",
    version="1.0.0"
)
...
async def list_tools():
    ...
    tools = [
        {
            "name": "gcp_mcp_status",
            "description": "Gcp Mcp Status for gcp-mcp",
            "parameters": {
                "type": "object",
                "properties": {
        ...
        {
            "name": "gcp_mcp_info",
            "description": "Gcp Mcp Info for gcp-mcp",
            "parameters": {
                "type": "object",
                "properties": {
                    "input": {"type": "string", "description": "Input parameter"}
...
async def call_tool(request: dict):
    ...
    if "status" in tool_name:
        ...
        result["result"] = {
            "name": "gcp-mcp",
            "type": "mcp_server",
            "capabilities": ['gcp_mcp_status', 'gcp_mcp_info'],
            "version": "1.0.0"
        }
...
if __name__ == "__main__":
    print(f"🚀 Starting {'gcp-mcp'} on port 8014")
    uvicorn.run(
        "__main__:app",
        host="0.0.0.0",
        port=8014,
