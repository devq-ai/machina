...
app = FastAPI(
    title="memory-mcp",
    description="Production MCP Server for memory-mcp",
    version="1.0.0"
)
    ...
    tools = [
        {
            ...
            "description": "Memory Mcp Status for memory-mcp",
            "parameters": {
                "type": "object",
                "properties": {
        ...
        {
            "name": "memory_mcp_info",
            "description": "Memory Mcp Info for memory-mcp",
            "parameters": {
                "type": "object",
                "properties": {
                    "input": {"type": "string", "description": "Input parameter"}
...
async def call_tool(request: dict):
    ...
    if "status" in tool_name:
        ...
        result["result"] = {
            "name": "memory-mcp",
            "type": "mcp_server",
            "capabilities": ['memory_mcp_status', 'memory_mcp_info'],
            "version": "1.0.0"
        }
...
if __name__ == "__main__":
    print(f"🚀 Starting {'memory-mcp'} on port 8028")
    uvicorn.run(
        "__main__:app",
        host="0.0.0.0",
        port=8028,
