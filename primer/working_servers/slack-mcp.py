...
app = FastAPI(
    title="slack-mcp",
    description="Production MCP Server for slack-mcp",
    version="1.0.0"
)
    ...
    tools = [
        {
            ...
            "description": "Slack Mcp Status for slack-mcp",
            "parameters": {
                "type": "object",
                "properties": {
        ...
        {
            "name": "slack_mcp_info",
            "description": "Slack Mcp Info for slack-mcp",
            "parameters": {
                "type": "object",
                "properties": {
                    "input": {"type": "string", "description": "Input parameter"}
...
async def call_tool(request: dict):
    ...
    if "status" in tool_name:
        ...
        result["result"] = {
            "name": "slack-mcp",
            "type": "mcp_server",
            "capabilities": ['slack_mcp_status', 'slack_mcp_info'],
            "version": "1.0.0"
        }
...
if __name__ == "__main__":
    print(f"🚀 Starting {'slack-mcp'} on port 8037")
    uvicorn.run(
        "__main__:app",
        host="0.0.0.0",
        port=8037,
